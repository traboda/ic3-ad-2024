...
void printFruits(){
  printf("%s\n\x1B[33m%s\x1B[0m\x1B[31m%s\x1B[0m\x1B[31m%s\x1B[0m\x1B[32m%s\x1B[0m\x1B[34m%s\x1B[0m%s",
...
void addPrintFunc(Fruit * fruit) {
  switch(fruit->type){
    case 1: fruit->ptr = &printBanana;
        break;
    case 2: fruit->ptr = &printApple;
        break;
    case 3: fruit->ptr = &printCherry;
        break;
    case 4: fruit->ptr = &printWatermelon;
        break;
    case 5: fruit->ptr = &printGrape;
        break;
    default: printf("Invalid fruit type \n");
        exit(0);
  }
}
...
int main(){
  ...
  while(1){
    ...
    case 5: saveBasket();
      break;
    case 6: restoreBasket();
      break;
    case 7: removeBasket();
      break;
    case 8: exit(0);
    case 0x1337: verifySignature();
      break;
    case 0x31337: viewWarehouse();
      break;
    default: exit(0);
    }
  }
